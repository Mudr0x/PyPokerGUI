...
src = os.path.join(root, "pypokergui_tomtest")
...
from pypokergui_tomtest.server.poker import start_server
from pypokergui_tomtest.config_builder import build_config
